            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Chart of Accounts</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Manage your accounts and track financial transactions with ease.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Transaction Management</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Record and track all financial transactions in one place.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6">
              <div className="flow-root bg-white rounded-lg px-6 pb-8 shadow-lg">
                <div className="-mt-6">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    Generate detailed financial reports to analyze your business performance.
                  </p>
                </div>
              </div>
            </div>
